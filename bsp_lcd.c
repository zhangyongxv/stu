...
//		 {}
			...
			{
			LCD_Fast_DrawPoint(x+cnt%16,cnt/16+y,WHITE);
			}
			cnt++;
	  }
	}
...
0x54,0x88,0x50,0x48,0x92,0x48,0x11,0x50,0x11,0x10,0x10,0x20,0x17,0xFE,0x10,0x00},/*"检",4*/

{0x00,0x04,0x27,0xC4,0x14,0x44,0x14,0x54,0x85,0x54,0x45,0x54,0x45,0x54,0x15,0x54,
0x15,0x54,0x25,0x54,0xE5,0x54,0x21,0x04,0x22,0x84,0x22,0x44,0x24,0x14,0x08,0x08},/*"测",5*/

{0x08,0x80,0x08,0x48,0x0A,0x48,0x12,0x08,0x12,0x08,0x31,0x10,0x31,0x10,0x51,0x10,
0x90,0xA0,0x10,0xA0,0x10,0x40,0x10,0x40,0x10,0xA0,0x11,0x10,0x12,0x08,0x14,0x06},/*"仪",6*/

{0x01,0x00,0xF9,0x08,0x09,0x08,0x09,0x10,0x09,0x20,0x79,0x40,0x41,0x00,0x47,0xFE,0x41,0x40,0x79,0x20,0x09,0x20,0x09,0x10,
0x09,0x08,0x09,0x44,0x51,0x82,0x21,0x00},/*"张",0*/
/* (16 X 16 , 宋体 )*/

{0x02,0x00,0x01,0x00,0x00,0x80,0x1F,0x00,0x01,0x04,0x01,0x08,0x7D,0x90,0x05,0xA0,0x05,0x40,0x09,0x40,0x09,0x20,0x11,0x10,
0x21,0x08,0xC1,0x06,0x05,0x00,0x02,0x00},/*"永",1*/
/* (16 X 16 , 宋体 )*/

{0x20,0x00,0x20,0xF8,0x20,0x88,0x20,0x88,0xFC,0x88,0x24,0xF8,0x24,0x88,0x24,0x88,0x24,0x88,0x24,0x88,0x24,0xF8,0x24,0x8A,
0x24,0x02,0x44,0x02,0x43,0xFE,0x80,0x00}/*"旭",2*/
/* (16 X 16 , 宋体 )*/
};
...
void LCD_ShowChineseStr(uint16_t x, uint16_t y,  uint16_t Color, char str[])
{
	...
	while(str[i] != '\0')//遍历字符串
	{
		...
		while(hz1616[j] != '\0')
		{
			...
			{
				LCD_showchinese(x, y, Hz_16_16[j/2],Color);
				x+=16;
