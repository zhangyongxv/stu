...
void LCD_DrawPoint(u16 x,u16 y);//花店
void LCD_Fast_DrawPoint(u16 x,u16 y,u16 color);//色点
void LCD_showchinese(uint16_t x, uint16_t y,uint8_t *p,uint16_t color);//汉字
void LCD_ShowChineseStr(uint16_t x, uint16_t y,  uint16_t Color, char str[]);
void LCD_Fill(u16 sx,u16 sy,u16 ex,u16 ey,u16 color);//填充
